    ...
    if os.path.isfile(file_path) and file_name.lower().endswith(('.png', '.jpg', '.jpeg')):
        ...
        if image.mode == "L" or image.histogram()[:256] == image.histogram()[256:512] == image.histogram()[512:]:
            ...
            if avg_diff < threshold:
                ...
                # Copy the image to the "train_copied" folder
                new_file_path = os.path.join(copied_folder_path, file_name)
                shutil.copy(file_path, new_file_path)
    return 0

threshold = 30  # average difference threshold

folder_path = '/opt/data/mydata/val'
copied_folder_path = '/opt/data/mydata/val2'
...
print(f"Images in '{folder_path}' processed successfully.")
